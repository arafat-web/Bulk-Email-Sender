...
@section('title', 'Add New Contact - BulkMailer')
    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h1 class="h3 mb-0 text-dark">Add New Contact</h1>
                    <p class="text-muted mb-0">Create a new email contact and assign tags</p>
                </div>
                    ...
                    <div class="card shadow-sm border-0">
                        <div class="card-header bg-white border-bottom">
                            <h5 class="mb-0 text-dark">
                                <i class="bi bi-person-plus me-2 text-primary"></i>Contact Information
                            </h5>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea class="form-control @error('notes') is-invalid @enderror"
                                                  id="notes" name="notes" rows="3" placeholder="Additional notes about this contact...">{{ old('notes') }}</textarea>
                                        @error('notes')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
