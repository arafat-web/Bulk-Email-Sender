...
@section('title', 'Edit Custom Field - BulkMailer')
    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h1 class="h3 mb-0 text-dark">Edit Custom Field</h1>
                    <p class="text-muted mb-0">Update custom field settings</p>
                </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="card shadow-sm border-0">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('custom-fields.update', $customField) }}" id="customFieldForm">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        <label class="form-label text-dark fw-medium">Field Name</label>
                                        <input type="text" class="form-control" value="{{ $customField->name }}" readonly>
                                        <div class="form-text">Field name cannot be changed as it may be used in email templates.</div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="text" class="form-control @error('label') is-invalid @enderror"
                                               id="label" name="label" value="{{ old('label', $customField->label) }}" required
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('default_value') is-invalid @enderror"
                                               id="default_value" name="default_value" value="{{ old('default_value', $customField->default_value) }}"
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea class="form-control @error('description') is-invalid @enderror"
                                                  ...
                                                  placeholder="Optional description to help users understand this field...">{{ old('description', $customField->description) }}</textarea>
                                        @error('description')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                                ...
                                                @foreach($customField->options as $key => $value)
                                                    <div class="option-row mb-2">
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" name="options[]" value="{{ $value }}" placeholder="Option value">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="is_required" 
                                                                   name="is_required" value="1" {{ old('is_required', $customField->is_required) ? 'checked' : '' }}>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input" id="is_active" 
                                                                   name="is_active" value="1" {{ old('is_active', $customField->is_active) ? 'checked' : '' }}>
                                    ...
                                    <div class="col-12">
                                        <div class="d-flex justify-content-end gap-2">
                                            ...
                                            <button type="submit" class="btn btn-primary">
                                                <i class="bi bi-check-circle me-2"></i>Update Custom Field
                                            </button>
                                        </div>
                                    </div>
                                </div>
